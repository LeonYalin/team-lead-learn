...
function itToBusinessAlignment() {
  logToHTML('' +
    ...
    The activity card:
    | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | |
    | 1/1/20 - start date _______________________________________ 3/1/20 - end date |
    | _____________________________________________________________________________ |
    | ______________________________ Project 1.1.2 ________________________________ |
    | _____________________________________________________________________________ |
    | 1.2/CEO - target/customer ________________________________ points - 80 hours  |
    | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | | |
    `);
}
